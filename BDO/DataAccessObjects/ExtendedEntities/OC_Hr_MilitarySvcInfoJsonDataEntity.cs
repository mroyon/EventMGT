...
namespace BDO.DataAccessObjects.ExtendedEntities
{
    ...
    /// </summary>
    [Serializable]
    [DataContract(Name = "OC_Hr_MilitarySvcInfoJsonDataEntity", Namespace = "http://www.KAF.com/types")]
    public class OC_Hr_MilitarySvcInfoJsonDataEntity : BaseEntity
    {
        [DataMember]
        ...
        public OC_Hr_MilitarySvcInfoJsonDataEntity() : base()
        {
        }
    }
}
