...
namespace WinFormReports.Models
{
    ...
    public class sahelNotificationRequestEntity
    {
        ...
        public List<DataTableAr> dataTableAr { get; set; }
        public List<DataTableEn> dataTableEn { get; set; }
    ...
    public class sahelNotificationRequestListEntity
    {
        ...
        public string bodyAr { get; set; }
        public string bodyEn { get; set; }
        public List<DataTableListAr> dataTableAr { get; set; }
        public List<DataTableListEn> dataTableEn { get; set; }
        public bool isForSubscriber { get; set; }
        public string notificationType { get; set; }
        public List<ActionButtonRequestList> actionButtonRequestList { get; set; }
    }
    ...
    public class sahelNotificationEntity
    {
        [DataMember]
        public string subscriberCivilId { get; set; }
        [DataMember]
    ...
    public class sahelNotificationBulkEntity
    {
        [DataMember]
        public List<string> subscriberCivilId { get; set; }
        [DataMember]
