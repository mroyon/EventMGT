...
{
    public sealed partial class Owin_UserLoginTrailUseCase : IOwin_UserLoginTrailUseCase
    {
        ...
        public async Task<bool> GetAll(Owin_UserLoginTrailRequest message, ICRUDRequestHandler<Owin_UserLoginTrailResponse> outputPort)
        {
            ...
            try
            {
                ...
                .GetAll(new owin_userlogintrailEntity(), cancellationToken);
                ...
                if (oblist != null && oblist.Count > 0)
                {
                    ...
                    var data = (from t in oblist
                                select new
                                {
                                    ...
                                    t.sessionid,
                                    t.usertoken,
                                    datatablebuttonscode = objDTBtnPanel.genDTBtnPanel(message.Objowin_userlogintrail.ControllerName, t.serialno, "serialno", _contextAccessor.HttpContext.User.Identity as ClaimsIdentity, btnActionList, _contextAccessor)
                                }).ToList();

                    outputPort.GetListView(new Owin_UserLoginTrailResponse(new AjaxResponse(oblist[0].RETURN_KEY, data), true, null));
        ...
        public async Task<bool> Save(Owin_UserLoginTrailRequest message, ICRUDRequestHandler<Owin_UserLoginTrailResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Save(new Owin_UserLoginTrailResponse(new AjaxResponse("200", _sharedLocalizer["DATA_SAVE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Update(Owin_UserLoginTrailRequest message, ICRUDRequestHandler<Owin_UserLoginTrailResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Update(new Owin_UserLoginTrailResponse(new AjaxResponse("200", _sharedLocalizer["DATA_UPDATE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                        ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Delete(Owin_UserLoginTrailRequest message, ICRUDRequestHandler<Owin_UserLoginTrailResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Delete(new Owin_UserLoginTrailResponse(new AjaxResponse("200", _sharedLocalizer["DATA_DELETE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                       ), true, null));
                return true;
            }
            catch (Exception ex)
