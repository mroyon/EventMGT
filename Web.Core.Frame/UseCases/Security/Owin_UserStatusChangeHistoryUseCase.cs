...
{
    public sealed partial class Owin_UserStatusChangeHistoryUseCase : IOwin_UserStatusChangeHistoryUseCase
    {
        ...
        public async Task<bool> GetAll(Owin_UserStatusChangeHistoryRequest message, ICRUDRequestHandler<Owin_UserStatusChangeHistoryResponse> outputPort)
        {
            ...
            try
            {
                ...
                .GetAll(new owin_userstatuschangehistoryEntity(), cancellationToken);
                ...
                if (oblist != null && oblist.Count > 0)
                {
                    ...
                    var data = (from t in oblist
                                select new
                                {
                                    ...
                                    t.comment,
                                    t.extrafld,
                                    datatablebuttonscode = objDTBtnPanel.genDTBtnPanel(message.Objowin_userstatuschangehistory.ControllerName, t.serial, "serial", _contextAccessor.HttpContext.User.Identity as ClaimsIdentity, btnActionList, _contextAccessor)
                                }).ToList();

                    outputPort.GetListView(new Owin_UserStatusChangeHistoryResponse(new AjaxResponse(oblist[0].RETURN_KEY, data), true, null));
        ...
        public async Task<bool> Save(Owin_UserStatusChangeHistoryRequest message, ICRUDRequestHandler<Owin_UserStatusChangeHistoryResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Save(new Owin_UserStatusChangeHistoryResponse(new AjaxResponse("200", _sharedLocalizer["DATA_SAVE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Update(Owin_UserStatusChangeHistoryRequest message, ICRUDRequestHandler<Owin_UserStatusChangeHistoryResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Update(new Owin_UserStatusChangeHistoryResponse(new AjaxResponse("200", _sharedLocalizer["DATA_UPDATE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                        ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Delete(Owin_UserStatusChangeHistoryRequest message, ICRUDRequestHandler<Owin_UserStatusChangeHistoryResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Delete(new Owin_UserStatusChangeHistoryResponse(new AjaxResponse("200", _sharedLocalizer["DATA_DELETE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                       ), true, null));
                return true;
            }
            catch (Exception ex)
