...
{
    public sealed partial class Owin_FormActionUseCase : IOwin_FormActionUseCase
    {
        ...
        public async Task<bool> GetAll(Owin_FormActionRequest message, ICRUDRequestHandler<Owin_FormActionResponse> outputPort)
        {
            ...
            try
            {
                ...
                .GetAll(new owin_formactionEntity(), cancellationToken);
                ...
                if (oblist != null && oblist.Count > 0)
                {
                    ...
                    var data = (from t in oblist
                                select new
                                {
                                    ...
                                    t.eventname,
                                    t.sequence,
                                    datatablebuttonscode = objDTBtnPanel.genDTBtnPanel(message.Objowin_formaction.ControllerName, t.formactionid, "formactionid", _contextAccessor.HttpContext.User.Identity as ClaimsIdentity, btnActionList, _contextAccessor)
                                }).ToList();

                    outputPort.GetListView(new Owin_FormActionResponse(new AjaxResponse(oblist[0].RETURN_KEY, data), true, null));
        ...
        public async Task<bool> Save(Owin_FormActionRequest message, ICRUDRequestHandler<Owin_FormActionResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Save(new Owin_FormActionResponse(new AjaxResponse("200", _sharedLocalizer["DATA_SAVE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Update(Owin_FormActionRequest message, ICRUDRequestHandler<Owin_FormActionResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Update(new Owin_FormActionResponse(new AjaxResponse("200", _sharedLocalizer["DATA_UPDATE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                        ), true, null));
                return true;
            }
            catch (Exception ex)
        ...
        public async Task<bool> Delete(Owin_FormActionRequest message, ICRUDRequestHandler<Owin_FormActionResponse> outputPort)
        {
            ...
            try
            {
                ...
                outputPort.Delete(new Owin_FormActionResponse(new AjaxResponse("200", _sharedLocalizer["DATA_DELETE_CONFIRMATION"].Value, CLL.LLClasses._Status._statusSuccess, CLL.LLClasses._Status._titleInformation, "/"
                       ), true, null));
                return true;
            }
            catch (Exception ex)
