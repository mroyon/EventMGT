...
namespace  Web.Core.Frame.Presenters
{
    ...
    /// </summary>
    public sealed partial class Owin_UserPrefferencesSettingsPresenter : IOutputPort<Owin_UserPrefferencesSettingsResponse>, ICRUDRequestHandler<Owin_UserPrefferencesSettingsResponse>
    {
         /// <summary>
        /// ContentResult
        /// </summary>
        ...
        public void GetAll(Owin_UserPrefferencesSettingsResponse response)
        {
            ...
            Result = response.Success ? response._owin_UserPrefferencesSettingsList as object : response.Errors;
        }
        /// <summary>
        /// GetAllPaged
        /// </summary>
        ...
        public void GetSingle(Owin_UserPrefferencesSettingsResponse response)
        {
            ...
            Result = response.Success ? response._owin_UserPrefferencesSettings as object : response.Errors;
        }
        ...
        {
            ContentResult.StatusCode = (int)(response.Success ? HttpStatusCode.OK : httpStatusCodeParser.SetHttpStatusCode(response.Errors));
            ContentResult.Content = response.Success ? JsonSerializer.SerializeObject(new Owin_UserPrefferencesSettingsResponse(response._ajaxresponse, response.Success)) : JsonSerializer.SerializeObject(response.Errors);
