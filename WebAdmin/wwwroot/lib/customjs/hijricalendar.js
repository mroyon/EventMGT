...
function getwriteIslamicDate(adjustment,date,returnedvalue) {
		...
		var iMonthNames = new Array('محرم', 'صفر', 'ربيع الأول', 'ربيع الآخر', 'جمادى الأولى', 'جمادى الآخرة', 'رجب', 'شعبان', 'رمضان', 'شوال',
		    'ذو القعدة', 'ذو الحجة');
...
//function getIslamicDayNumeric(englishDayNumeric) {

//	var wdNames = new Array("١", "٢", "٣", "٤", "٥", "٦", "٧", "٨", "٩", "١٠", "١١", "١٢", "١٣", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", );



//	if (englishDayNumeric != null) {
//		switch (returnedvalue) {
//			case "1":
//				return iDate[7];
//				break;
