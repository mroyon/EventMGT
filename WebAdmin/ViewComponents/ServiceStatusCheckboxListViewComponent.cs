...
namespace WebAdmin.ViewComponents.Select2
{
    ...
    /// </summary>
    public class ServiceStatusCheckboxListViewComponent : ViewComponent
    {
        private readonly ILogger<ServiceInfoCheckboxListViewComponent> _logger;
        private readonly IStringLocalizer _sharedLocalizer;
        /// <summary>
        /// S2Gen_NewsCategoryViewComponent
        /// </summary>
        public ServiceStatusCheckboxListViewComponent(
            ILoggerFactory loggerFactory,
            IStringLocalizerFactory factory
            )
        {
            _logger = loggerFactory.CreateLogger<ServiceInfoCheckboxListViewComponent>();
