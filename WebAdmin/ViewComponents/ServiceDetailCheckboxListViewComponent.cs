...
namespace WebAdmin.ViewComponents.Select2
{
    ...
    /// </summary>
    public class ServiceDetailCheckboxListViewComponent : ViewComponent
    {
        private readonly ILogger<ServiceDetailCheckboxListViewComponent> _logger;
        private readonly IStringLocalizer _sharedLocalizer;
        /// <summary>
        /// S2Gen_NewsCategoryViewComponent
        /// </summary>
        public ServiceDetailCheckboxListViewComponent(
            ILoggerFactory loggerFactory,
            IStringLocalizerFactory factory
            )
        {
            _logger = loggerFactory.CreateLogger<ServiceDetailCheckboxListViewComponent>();
