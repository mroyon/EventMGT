...
/// <summary>
	...
	/// </summary>
	public class S2Gen_UnitViewComponent : ViewComponent
	{
		private readonly ILogger<S2Gen_UnitViewComponent> _logger;
		private readonly IStringLocalizer _sharedLocalizer;
		/// <summary>
		/// S2Gen_UnitViewComponent
		/// </summary>
		public S2Gen_UnitViewComponent(
			ILoggerFactory loggerFactory,
			IStringLocalizerFactory factory
			)
		{
			_logger = loggerFactory.CreateLogger<S2Gen_UnitViewComponent>();
